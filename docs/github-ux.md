...
10. Blind Review Arena: why accuracy claims can be blinded, scored, and adjudicated.
11. System map: how inputs become calibrated outputs.
12. Interview loop: why each round feels progressive.
13. Evidence ledger: why the answer is not a black box.
14. Quality gates: why the project is maintainable.
...
- Keep the seven precise SVG blueprints in `docs/assets/`: `repository-experience-map.svg`, `typing-engine-blueprint.svg`, `trust-loop-dashboard.svg`, `benchmark-arena-pipeline.svg`, `type-coverage-matrix.svg`, `calibration-loop-map.svg`, and `blind-review-arena.svg`.
