...
def check_docs(root: Path) -> list[Check]:
    ...
    return [
        ...
        Check("agent_adapters:manifest_question_ux", "low-typing-choice-first" == agent_manifest.get("interaction_contract", {}).get("name") and "Other / none of these" in str(agent_manifest.get("interaction_contract", {})), "Agent adapter manifest defines the low-typing choice-first question UX"),
        ...
        Check("agent_adapters:root_question_ux", all(term in root_agents for term in ("low-typing", "native question UI", "AskQuestion", "AskUserQuestion", "request_user_input", "Other / none of these")), "Root AGENTS.md preserves native-question and low-typing fallback guidance"),
        ...
        Check("agent_adapters:claude_code_question_ux", all(term in claude_skill + claude_command for term in ("AskUserQuestion", "A/B/C/D/E", "Other / none of these")), "Claude Code adapter preserves low-typing question UX"),
        ...
        Check("agent_adapters:cursor_question_ux", all(term in cursor_rule for term in ("AskQuestion", "A/B/C/D/E", "Other / none of these", "active mode or tool list")), "Cursor MDC rule preserves native-question gating and low-typing fallback"),
        ...
        Check("agent_adapter_lab:question_ux", all(term in agent_adapter_lab for term in ("low-typing", "native question UI", "Question UX", "Other / none of these")), "Agent Adapter Lab exposes the low-typing question UX contract"),
        ...
        Check("response_eval:choice_first_gate", "choice_first_questions" in response_eval_audit and "choice_first_questions" in json.dumps(response_eval_payload), "Response evaluation audits choice-first low-typing live questions"),
        ...
        Check("response_eval_lab:choice_first_gate", "choice_first_questions" in response_eval_lab and "Choice-first UX" in response_eval_lab, "Response Eval Lab exposes the choice-first question gate"),
        ...
        Check("question_lab:low_typing_prompt", all(term in question_lab for term in ("low-typing", "native question UI", "Other / none of these")), "Question Lab round prompt preserves low-typing choice UX"),
