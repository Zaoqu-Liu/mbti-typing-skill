...
Please report security issues privately when possible. Do not post secrets, tokens, private conversation logs, or sensitive personality reports in public issues.

This project is not intended for clinical diagnosis, hiring, school admission, legal decisions, or any high-stakes selection workflow. Reports that enable those uses should be treated as safety issues.
